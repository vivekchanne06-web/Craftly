...
exports.isSampledById = void 0;
const xxhash_js_1 = require("./xxhash/xxhash.cjs");
const SAMPLING_HASH_MODULUS = 1000000n;
 ...
 */
const isSampledById = (identifier, samplingRate) => {
    ...
    const bucket = (0, xxhash_js_1.XXH3_128)(encoder.encode(identifier.toLowerCase())) % SAMPLING_HASH_MODULUS;
    return Number(bucket) / Number(SAMPLING_HASH_MODULUS) < samplingRate;
};
exports.isSampledById = isSampledById;
