...
import { AppsV1Api, CoreV1Api } from './gen/index.js';
...
export class PortForward {
     ...
     */
    async portForwardService(namespace, serviceName, targetPorts, output, err, input, retryCount = 0) {
        var _a;
        ...
        if (!((_a = service.spec) === null || _a === void 0 ? void 0 : _a.selector) || Object.keys(service.spec.selector).length === 0) {
     ...
     */
    async portForwardDeployment(namespace, deploymentName, targetPorts, output, err, input, retryCount = 0) {
        var _a, _b;
        ...
        if (!((_b = (_a = deployment.spec) === null || _a === void 0 ? void 0 : _a.selector) === null || _b === void 0 ? void 0 : _b.matchLabels) ||
     ...
     */
    async getFirstReadyPod(namespace, labelSelector) {
        const coreApi = this.config.makeApiClient(CoreV1Api);
    ...
    isPodReady(pod) {
        var _a;
        if (!((_a = pod.status) === null || _a === void 0 ? void 0 : _a.conditions)) {
            return false;
        }
